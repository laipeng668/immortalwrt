...
define KernelPackage/libie-adminq
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=Intel Ethernet administration queue helpers
  DEPENDS:=@LINUX_6_18
...
define KernelPackage/libie-adminq/description
 Shared administration queue helpers for Intel Ethernet drivers.
endef
...
define KernelPackage/libie-fwlog
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=Intel Ethernet firmware logging helpers
  DEPENDS:=@LINUX_6_18 +kmod-libie-adminq
...
define KernelPackage/libie-fwlog/description
 Firmware logging helpers for Intel Ethernet drivers.
endef
...
define KernelPackage/ice
  ...
  DEPENDS:=@PCI_SUPPORT +kmod-ptp +kmod-hwmon-core +kmod-libie +LINUX_6_18:kmod-libie-adminq +LINUX_6_18:kmod-libie-fwlog
  KCONFIG:=CONFIG_ICE \
    CONFIG_ICE_HWMON=y \
    CONFIG_ICE_HWTS=y \
...
define KernelPackage/iavf
  ...
  DEPENDS:=@PCI_SUPPORT +kmod-libie +LINUX_6_18:kmod-libie-adminq +LINUX_6_18:kmod-ptp
  KCONFIG:= \
       CONFIG_I40EVF \
       CONFIG_IAVF
  FILES:= \
